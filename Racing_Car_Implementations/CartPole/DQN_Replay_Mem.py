...
class Replay_Memory:
    ...
    def __init__(self,capacity):
        ...
        self.memory_states = np.empty(capacity, dtype=object)
        ...
        self.memory_next_states = np.empty(capacity, dtype=object)
    ...
    def random_memory_batch(self, batch_size):
        ...
        random_memory_states = np.empty([], dtype=object)
        ...
        random_memory_next_states = np.empty([], dtype=object)
